...
//            if(response["message"]!="error") {
                firstname=response["firstname"];console.log("hh");
                ...
                $("#commentlist").prepend("<div> <div class=\"col-md-5\"> <p>"+firstname+" " +lastname+"</p> </div> <div class=\"col-md-7\"><span float=\"right\">"+timestamp+"</small> </div> <div class=\"col-md-12\"><p>"+text+"</p></div></div><hr><hr>");
